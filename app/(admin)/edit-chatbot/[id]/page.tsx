...
function EditChatbot({ params: { id } }: { params: { id: string } }) {
      ...
      try {
         ...
         const promise = addCharacteristic({
            variables: {
               chatbotId: Number(id),
               content,
               created_at: new Date().toISOString() // Adicionando created_at
            }
         });
   ...
   async function handleUpdateChatbot(e: FormEvent<HTMLFormElement>) {
      e.preventDefault();
   ...
   return (
      <div className="px-0 md:p-10">
         ...
         <section className="relative mt-5 bg-white p-5 md:p-10 rounded-lg">
            ...
            <h2 className="text-xl font-bold mt-10">Here's what yout AI knows...</h2>
            <p>
               Your chatbot is equiped with the following information
               to assist you in your conversations with your customers & users
            </p>
            <div className="bg-gray-200 p-5 md:p-5 rounded-md mt-5">
               ...
               >
                  <Input
                     type="text"
                     placeholder="Example: If a customer asks for prices, provide princing page: www.example.com/pricing"
